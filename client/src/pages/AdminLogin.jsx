            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full border border-slate-300 p-3 pr-10 text-sm focus:outline-none focus:border-red-800 focus:ring-1 focus:ring-red-800 rounded-sm"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute inset-y-0 right-3 flex items-center text-slate-500 hover:text-slate-800 cursor-pointer"
                >
                  {showPassword ? (
